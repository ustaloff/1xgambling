...
function aces_casinos_ratings_display_meta_box( $casino ) {
	...
	if ( get_option( 'aces_rating_custom_value') ) {

		$casino_rating_trust = get_post_meta( $casino->ID, 'casino_rating_trust', true );
		$casino_rating_games = get_post_meta( $casino->ID, 'casino_rating_games', true );
		$casino_rating_bonus = get_post_meta( $casino->ID, 'casino_rating_bonus', true );
		$casino_rating_customer = get_post_meta( $casino->ID, 'casino_rating_customer', true );
	...
	$max_value_notice = esc_html( 'Maximum value ', 'aces' ) . esc_html( $rating_stars_number_value );
	$custom_placeholder = esc_html( $rating_stars_number_value - 0.2 );
...
<div class="components-base-control casino_rating_trust">
	<div class="components-base-control__field">
		...
		<div class="aces-single-rating-box">
			...
			<?php if ( get_option( 'aces_rating_custom_value') ) { ?>

				<input type="number" name="casino_rating_trust" id="casino_rating_trust-0" value="<?php echo esc_attr($casino_rating_trust); ?>" placeholder="<?php echo esc_attr($custom_placeholder); ?>" min="1" max="<?php echo esc_attr($rating_stars_number_value); ?>" style="width: 150px; display: block; margin-bottom: 3px; margin-top: 3px;" />
				<em>
					<?php esc_html_e( $max_value_notice ); ?>
				</em>
	...
	<div class="components-base-control__field">
		...
		<div class="aces-single-rating-box">
			...
			<?php if ( get_option( 'aces_rating_custom_value') ) { ?>
				...
				<input type="number" name="casino_rating_games" id="casino_rating_games-0" value="<?php echo esc_attr($casino_rating_games); ?>" placeholder="<?php echo esc_attr($custom_placeholder); ?>" min="1" max="<?php echo esc_attr($rating_stars_number_value); ?>" style="width: 150px; display: block; margin-bottom: 3px; margin-top: 3px;" />
				<em>
					<?php esc_html_e( $max_value_notice ); ?>
				</em>
	...
	<div class="components-base-control__field">
		...
		<div class="aces-single-rating-box">
			...
			<?php if ( get_option( 'aces_rating_custom_value') ) { ?>
				...
				<input type="number" name="casino_rating_bonus" id="casino_rating_bonus-0" value="<?php echo esc_attr($casino_rating_bonus); ?>" placeholder="<?php echo esc_attr($custom_placeholder); ?>" min="1" max="<?php echo esc_attr($rating_stars_number_value); ?>" style="width: 150px; display: block; margin-bottom: 3px; margin-top: 3px;" />
				<em>
					<?php esc_html_e( $max_value_notice ); ?>
				</em>
	...
	<div class="components-base-control__field">
		...
		<div class="aces-single-rating-box">
			...
			<?php if ( get_option( 'aces_rating_custom_value') ) { ?>
				...
				<input type="number" name="casino_rating_customer" id="casino_rating_customer-0" value="<?php echo esc_attr($casino_rating_customer); ?>" placeholder="<?php echo esc_attr($custom_placeholder); ?>" min="1" max="<?php echo esc_attr($rating_stars_number_value); ?>" style="width: 150px; display: block; margin-bottom: 3px; margin-top: 3px;" />
				<em>
					<?php esc_html_e( $max_value_notice ); ?>
				</em>
...
function aces_casinos_ratings_save_fields( $post_id ) {
        ...
        if ( get_option( 'aces_rating_custom_value') ) {
        	...
        	$casino_rating_trust = sanitize_text_field( $_POST['casino_rating_trust'] );
        	update_post_meta( $post_id, 'casino_rating_trust', $casino_rating_trust );

        	$casino_rating_games = sanitize_text_field( $_POST['casino_rating_games'] );
        	update_post_meta( $post_id, 'casino_rating_games', $casino_rating_games );

        	$casino_rating_bonus = sanitize_text_field( $_POST['casino_rating_bonus'] );
        	update_post_meta( $post_id, 'casino_rating_bonus', $casino_rating_bonus );

        	$casino_rating_customer = sanitize_text_field( $_POST['casino_rating_customer'] );
        	update_post_meta( $post_id, 'casino_rating_customer', $casino_rating_customer );
...
if (get_theme_mod( 'mercury_old_pros_cons_casinos')) {
	...
	function aces_casinos_pros_cons_fields() {
	    add_meta_box( 'aces_casinos_pros_cons_meta_box',
	        esc_html__( 'Pros/Cons of the casino (old)', 'aces' ),
...
function aces_casinos_display_meta_box( $casino ) {
	...
	if ( get_option( 'aces_casino_link_mask_slug') ) {
		$casino_mask_link = get_post_meta( $casino->ID, 'casino_mask_link', true );
	}
...
<?php if ( get_option( 'aces_casino_link_mask_slug') ) { ?>

	<div class="components-base-control casino_mask_link">
		<div class="components-base-control__field">
			<label class="components-base-control__label" for="casino_mask_link-0"><?php esc_html_e( 'Custom slug to mask external URL', 'aces' ); ?></label>
			<input type="text" name="casino_mask_link" id="casino_mask_link-0" value="<?php echo esc_attr($casino_mask_link); ?>" style="display: block; margin-bottom: 10px;" />
		</div>
	</div>
...
function aces_casinos_save_fields( $post_id ) {
        ...
        if ( get_option( 'aces_casino_link_mask_slug') ) {
        	...
        	$casino_mask_link = sanitize_text_field( $_POST['casino_mask_link'] );
        	update_post_meta( $post_id, 'casino_mask_link', $casino_mask_link );
