            ...
            $('.recommeded-plugins-hide').on('click', function (event) {
                ...
                $("#hide-recommeded-plugins").dialog({
                    ...
                    buttons: {
                        "Hide it": {
                            click: function () {
                                window.location = "<?php echo admin_url('admin.php?page=quick-301-redirects-plugins&quick_301_redirects_plugins_page=1&qtr_nonce='.wp_create_nonce('quick_301_redirects_plugins_page'));?>";
                            },
                            text: 'Hide it',
                            class: 'btn red-btn'
                        },
