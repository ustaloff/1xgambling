...
/*  Dark Mode Colors  */
	...
	$wp_customize->add_section( 'mercury_dark_colors' , array(
	    'title'      => esc_html__( 'Dark Mode', 'mercury' ),
	    'priority'   => 170,
	) );

	/*  --- Enable Dark mode ---  */

	$wp_customize->add_setting( 'mercury_enable_dark_mode', array(
		'default' => false,
		'sanitize_callback' => 'mercury_sanitize_checkbox',
		'capability' =>  'edit_theme_options'
	 ) );

	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'mercury_enable_dark_mode', array(
		'label' => esc_html__( 'Enable Dark Mode', 'mercury' ),
	    'section'  => 'mercury_dark_colors',
	    'settings' => 'mercury_enable_dark_mode',
	    'type'     => 'checkbox'
	)));

    /*  Main Background Color  */

    $wp_customize->add_setting( 'dark_main_background', array(
		'default' => '#121315',
		'sanitize_callback' => 'sanitize_hex_color',
		'capability' =>  'edit_theme_options'
	) );

    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'dark_main_background', array(
	    'label'   => esc_html__( 'Main Background Color', 'mercury' ),
	    'section' => 'mercury_dark_colors',
	    'settings'   => 'dark_main_background'
	)));

    /*  Second Background Color  */

    $wp_customize->add_setting( 'dark_second_background', array(
		'default' => '#202427',
		'sanitize_callback' => 'sanitize_hex_color',
		'capability' =>  'edit_theme_options'
	) );

    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'dark_second_background', array(
	    'label'   => esc_html__( 'Second Background Color', 'mercury' ),
	    'section' => 'mercury_dark_colors',
	    'settings'   => 'dark_second_background'
	)));

	/*  Third Background Color  */

    $wp_customize->add_setting( 'dark_third_background', array(
		'default' => '#2d3337',
		'sanitize_callback' => 'sanitize_hex_color',
		'capability' =>  'edit_theme_options'
	) );

    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'dark_third_background', array(
	    'label'   => esc_html__( 'Third Background Color', 'mercury' ),
	    'section' => 'mercury_dark_colors',
	    'settings'   => 'dark_third_background'
	)));

	/*  Fourth Background Color  */

    $wp_customize->add_setting( 'dark_fourth_background', array(
		'default' => '#151515',
		'sanitize_callback' => 'sanitize_hex_color',
		'capability' =>  'edit_theme_options'
	) );

    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'dark_fourth_background', array(
	    'label'   => esc_html__( 'Fourth Background Color', 'mercury' ),
	    'section' => 'mercury_dark_colors',
	    'settings'   => 'dark_fourth_background'
	)));

	/*  Titles Color  */

    $wp_customize->add_setting( 'dark_title_color', array(
		'default' => '#fff',
		'sanitize_callback' => 'sanitize_hex_color',
		'capability' =>  'edit_theme_options'
	) );

    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'dark_title_color', array(
	    'label'   => esc_html__( 'Titles Color', 'mercury' ),
	    'section' => 'mercury_dark_colors',
	    'settings'   => 'dark_title_color'
	)));

	/*  Second Text Color  */

    $wp_customize->add_setting( 'dark_second_text_color', array(
		'default' => '#c3c7c8',
		'sanitize_callback' => 'sanitize_hex_color',
		'capability' =>  'edit_theme_options'
	) );

    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'dark_second_text_color', array(
	    'label'   => esc_html__( 'Second Text Color', 'mercury' ),
	    'section' => 'mercury_dark_colors',
	    'settings'   => 'dark_second_text_color'
	)));

	/*  Third Text Color  */

    $wp_customize->add_setting( 'dark_third_text_color', array(
		'default' => '#7f8c8d',
		'sanitize_callback' => 'sanitize_hex_color',
		'capability' =>  'edit_theme_options'
	) );

    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'dark_third_text_color', array(
	    'label'   => esc_html__( 'Third Text Color', 'mercury' ),
	    'section' => 'mercury_dark_colors',
	    'settings'   => 'dark_third_text_color'
	)));
...
/*  Header Settings  */
	...
	$wp_customize->add_setting( 'header_h1_title_color', array(
		'default' => '#151515',
		'sanitize_callback' => 'sanitize_hex_color',
		'capability' =>  'edit_theme_options'
	) );

    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_h1_title_color', array(
	    'label'   => esc_html__( 'H1 title color', 'mercury' ),
	    'section'  => 'mercury_header_settings',
	    'settings' => 'header_h1_title_color',
	)));

	/*  --- Title box background color ---  */

	$wp_customize->add_setting( 'header_title_box_background_color', array(
		'default' => '#f1f3f4',
		'sanitize_callback' => 'sanitize_hex_color',
		'capability' =>  'edit_theme_options'
	) );

    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_title_box_background_color', array(
	    'label'   => esc_html__( 'Title box background color', 'mercury' ),
	    'section'  => 'mercury_header_settings',
	    'settings' => 'header_title_box_background_color',
	)));

	/*  --- Title box text color ---  */

	$wp_customize->add_setting( 'header_title_box_text_color', array(
		'default' => '#7f8c8d',
		'sanitize_callback' => 'sanitize_hex_color',
		'capability' =>  'edit_theme_options'
	) );

    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_title_box_text_color', array(
	    'label'   => esc_html__( 'Title box text color', 'mercury' ),
	    'section'  => 'mercury_header_settings',
	    'settings' => 'header_title_box_text_color',
	)));
...
/*  Footer Settings  */
    ...
    $wp_customize->add_setting('mercury_footer_bg', array(
        'sanitize_callback' => 'mercury_sanitize_file',
        'capability' =>  'edit_theme_options'
    ));

    $wp_customize->add_control( new WP_Customize_Upload_Control( $wp_customize, 'mercury_footer_bg', array(
        'label' => esc_html__( 'Background image for the footer', 'mercury' ),
        'description' => esc_html__( 'Recommended background image size 2000 x 500 px.', 'mercury' ),
        'section' => 'mercury_footer_settings',
        'settings' => 'mercury_footer_bg'
    )));
...
/*  Aces Settings  */
	...
	$wp_customize->add_section( 'mercury_aces_cpt_settings', array(
        'title' => esc_html__( 'CPT settings', 'mercury' ),
        'panel' => 'mercury_aces'
    ) );

    /*  --- Enable old Pros/Cons for Casinos ---  */

    $wp_customize->add_setting( 'mercury_old_pros_cons_casinos', array(
		'default' => false,
		'sanitize_callback' => 'mercury_sanitize_checkbox',
		'capability' =>  'edit_theme_options'
	) );

	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'mercury_old_pros_cons_casinos', array(
		'label' => esc_html__( 'Enable old Pros/Cons for Organizations (Casinos)', 'mercury' ),
	    'section'  => 'mercury_aces_cpt_settings',
	    'settings' => 'mercury_old_pros_cons_casinos',
	    'type'     => 'checkbox'
	)));

    /*  --- Enable old Pros/Cons for Games ---  */

    $wp_customize->add_setting( 'mercury_old_pros_cons_games', array(
		'default' => false,
		'sanitize_callback' => 'mercury_sanitize_checkbox',
		'capability' =>  'edit_theme_options'
	) );

	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'mercury_old_pros_cons_games', array(
		'label' => esc_html__( 'Enable old Pros/Cons for Units (Games)', 'mercury' ),
	    'section'  => 'mercury_aces_cpt_settings',
	    'settings' => 'mercury_old_pros_cons_games',
	    'type'     => 'checkbox'
	)));
    ...
    /*  --- Bonuse's archive layout style ---  */

	$wp_customize->add_setting( 'mercury_bonus_archive_style', array(
		'default' => false,
		'sanitize_callback' => 'mercury_sanitize_radio',
		'capability' =>  'edit_theme_options'
	 ) );
         
    $wp_customize->add_control( 'mercury_bonus_archive_style', array(
        'label' => esc_html__( 'The layout style of offer (bonus) listing pages (archive and taxonomy)', 'mercury' ),
        'section' => 'mercury_aces_settings',
        'type' => 'radio',
        'choices' => array(
            '1' => esc_html__('#1 Style', 'mercury'),
...
/*  Other Settings  */
	...
	/*  --- Enable a game float bottom bar ---  */

	$wp_customize->add_setting( 'mercury_game_float_bar', array(
		'default' => false,
		'sanitize_callback' => 'mercury_sanitize_checkbox',
		'capability' =>  'edit_theme_options'
	 ) );

	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'mercury_game_float_bar', array(
		'label' => esc_html__( 'Enable an unit (game) float bottom bar', 'mercury' ),
	    'section'  => 'mercury_posts_settings',
	    'settings' => 'mercury_game_float_bar',
	    'type'     => 'checkbox'
	)));
